...
//获取我的积分记录
const getMineScore = ({commit, state}) => getMine({commit, state}).then(async() => commit(GET_DATA_LIST, await mineScoreApi(state.login.id, 0, state.page)));
//获取我的消息记录
...
//获取我的工会活动
const getMineActivity = ({commit, state}) => getMine({commit, state}).then(async() => commit(GET_DATA_LIST, await mineActivityApi(1, state.page)));
//获取我的健身项目
const getMineHealth = ({commit, state}) => getMine({commit, state}).then(async() => commit(GET_DATA_LIST, await mineHealthApi(1, state.page)));
//公共删除方法
