        ...
        <MyTable :data="list">
          ...
          <MyColumn label="操作">
            <template scope="scope">
              <el-button type="text" size="small" @click="go(['sportEdit',scope.row.id])">编辑</el-button>
              <el-button size="small" type="text" @click="go(['sportEdit',scope.row.id])">预约管理</el-button>
