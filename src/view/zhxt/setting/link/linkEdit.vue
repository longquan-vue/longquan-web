...
<template>
  <div class="contentBox link_box">
    ...
    <div class="contentBoxCont">
      <el-form :model="data" ref="data" label-width="80px" class="demo-ruleForm">
        <el-row v-for="(link,idx) in data.links" :key="idx">
          ...
          <el-col :span="5">
            <el-form-item label="所属类型：" label-width="100px" :prop="'links.'+idx+'.type'" :rules="[{required:true,message:'所属类型不能为空！'}]">
