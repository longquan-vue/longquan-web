                        ...
                        <div class="grid-left">
                            <div class="the-place" style="">
                                <el-breadcrumb separator="/">
                                    ...
                                    <el-breadcrumb-item>劳模服务</el-breadcrumb-item>
                                </el-breadcrumb>
                            </div>
                            <div class="wzzy-sub-title" style="margin-bottom:0"><a><i class="iconfont icon-xinwendongtai"></i>劳模服务</a></div>
                            <div class="wzzy-sub-content">
                                <ul class="newTips" v-for="i in 20">
                                    <li><a><span>{{i}}、这是劳模服务相关信息哦。</span> <i>2017-04-15  10:30</i></a></li>
                                </ul>
                            </div>
                        </div>
                    </el-col>
