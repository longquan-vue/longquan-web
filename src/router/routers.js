...
export default [
  ...
  // 服务号
  {
      ...
      children:[
          ...
          {path: `${ROOT}/fwh/health`, component:() => System.import('../view/fwh/health/health.vue'), name: 'fwhhealth'}, //健身中心
          ...
          {path: `${ROOT}/fwh/recruit`, component:() => System.import('../view/fwh/recruit/recruit.vue'), name: 'recruit'}, //招聘信息
          {path: `${ROOT}/fwh/recruitSign`, component:() => System.import('../view/fwh/recruit/recruitSign.vue'), name: 'recruitSign'}, //招聘信息报名
      ]
  },
]
